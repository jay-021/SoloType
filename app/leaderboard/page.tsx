    ...
    <div className="container px-4 py-8 md:py-12">
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-20">
          <div className="mb-4 h-16 w-16 animate-spin rounded-full border-4 border-solo-purple/30 border-t-solo-purple-light"></div>
        ...
        <>
          <div className="mb-12">
            <div className="mb-6 flex items-center">
              <Trophy className="mr-2 h-6 w-6 text-solo-purple-light" />
          ...
          <div className="mb-12">
            <div className="mb-6 flex items-center">
              <Users className="mr-2 h-6 w-6 text-solo-purple-light" />
          ...
          <div className="mb-8">
            <h2 className="mb-6 text-2xl font-bold">Custom Quests</h2>
            <ComingSoonSection />
          </div>
        </>
      )}
