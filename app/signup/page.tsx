    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container max-w-md mx-auto px-4 py-8 flex-1 flex flex-col justify-center relative z-10">
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-center mb-2 system-text">HUNTER REGISTRATION</h1>
          <p className="text-center text-gray-400 mb-8">Create your account to begin your typing journey</p>
        </motion.div>
