  ...
  return (
    ...
    >
      <div className="mb-8 flex items-center">
        ...
        <h1 className="solo-font glow-text text-3xl font-bold">
          Custom Typing Test
        </h1>
      </div>
      ...
      {!isTestReady ? (
        ...
        <Card className="mb-8 border-solo-purple/20 bg-solo-darkgray/80 p-6">
          <h2 className="mb-4 text-xl font-semibold">Enter Your Custom Text</h2>
          <p className="mb-6 text-gray-300">
            Paste or type the text you want to practice with. The test will
            begin once you click "Prepare Test".
          </p>
          ...
          <Textarea
            ...
            className="mb-6 min-h-[200px] border-solo-purple/30 bg-solo-black/50 focus:border-solo-purple-light"
          />

          <div className="mb-6">
            <h3 className="mb-2 text-lg font-semibold">Test Duration</h3>
        ...
        // Test area
        <Card
          className={`mb-8 border-solo-purple/20 bg-solo-darkgray/80 p-6 transition-all duration-500 ${
            typingSpeed === 'fast'
          ...
          {!isTestActive ? (
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="mb-8 max-w-2xl text-center text-gray-300">
                You've selected a {formatDuration(selectedDuration)} test with
                your custom text. Press Enter or click the button below to
                start.
              </p>
