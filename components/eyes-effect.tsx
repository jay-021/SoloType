    ...
    <div className={`eyes-container ${visible ? "visible" : ""}`}>
      <div
        ...
        style={{
          ...
          boxShadow:
            typingSpeed === "fast" ? "0 0 20px 10px rgba(59, 130, 246, 0.3)" : "0 0 20px 10px rgba(139, 92, 246, 0.3)",
        }}
      ></div>
      <div
        ...
        style={{
          ...
          background:
            typingSpeed === "fast"
              ...
              : "radial-gradient(circle, rgba(59, 130, 246, 0.8) 0%, rgba(59, 130, 246, 0) 70%)",
          boxShadow:
            typingSpeed === "fast" ? "0 0 20px 10px rgba(59, 130, 246, 0.3)" : "0 0 20px 10px rgba(59, 130, 246, 0.3)",
        }}
      ></div>
    </div>
  )
