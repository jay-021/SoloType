...
export default function LeaderboardTable({
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex space-x-1">
              {['s', 'a', 'b', 'c', 'd', 'e'].map((rank) => (
                <Button
                  ...
                  size="sm"
                  onClick={() => handleFilterChange(timeFilter, rank as 'all' | 's' | 'a' | 'b' | 'c' | 'd' | 'e')}
                  className={
                    rankFilter === rank
                      ? 'bg-solo-purple hover:bg-solo-purple-dark'
                      : ''
      ...
      <div className="overflow-hidden rounded-md border border-solo-purple/20">
        <Table>
          ...
          <TableBody>
            {leaderboardData.map((entry, index) => (
              <motion.tr
                ...
                } transition-colors hover:bg-solo-purple/10`}
              >
                <TableCell className="text-center font-mono">
                  <div className={`dungeon-rank ${entry.rank}-rank mx-auto`}>
