...
export default function TopTypistCard({ entry, position }: TopTypistCardProps) {
  ...
  return (
    ...
    >
      <Card
        className={`bg-gradient-to-b p-6 ${colors.bg} ${colors.border} ${colors.glow} relative overflow-hidden`}
      >
        ...
        <div className="mb-4 flex items-center">
          <div
            className={`flex h-12 w-12 items-center justify-center rounded-full bg-solo-black/50 ${colors.border} mr-4`}
          >
        ...
        <div className="mt-4 grid grid-cols-2 gap-4">
          <div className="rounded-md bg-solo-black/40 p-3 text-center">
            <div className="text-sm text-gray-400">WPM</div>
            <div className="font-mono text-2xl font-bold">{entry.wpm}</div>
          </div>
          <div className="rounded-md bg-solo-black/40 p-3 text-center">
